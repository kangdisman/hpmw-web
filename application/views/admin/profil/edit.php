...
<form class="form-horizontal" action="<?php echo base_url('admin/dashboard/update_profil'); ?>" method="POST">
    <input type="hidden" name="id" value="<?php echo $profil['id']; ?>">
    <fieldset>
        <legend>Silahkan update profil organisasi anda</legend>
        <div class="control-group">
            <label class="control-label">Judul</label>
            <div class="controls">
                <input type="text" class="span4" name="judul" value="<?php echo $profil['judul']; ?>">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">Profil</label>
            <div class="controls">
                <textarea  name="profil" rows="15"><?php echo $profil['profil']; ?></textarea>
            </div>
        </div>
