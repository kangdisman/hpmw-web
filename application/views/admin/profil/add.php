...
<form class="form-horizontal" method="POST" action="<?= base_url('admin/dashboard/add_profil'); ?>">
	<input type="hidden" name="id">
	<fieldset>
		<legend>Silahkan masukkan data profil organisasi anda</legend>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="judul" type="text" class="span7" placeholder="Input titel profil">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">Profil</label>
			<div class="controls">
				<textarea  name="profil" rows="15"></textarea>
			</div>
		</div>
