...
<form class="form-horizontal" action="<?php echo base_url('admin/artikel/update'); ?>" method="POST">
    <input type="hidden" name="id_artikel" value="<?php echo $artikel['id_artikel']; ?>">
    <fieldset>
        <legend>Silahkan update artikel anda</legend>
        <div class="control-group">
            <label class="control-label">Judul</label>
            <div class="controls">
                <input type="text" class="span7" name="judul" value="<?php echo $artikel['judul']; ?>">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">Isi artikel</label>
            <div class="controls">
                <textarea  name="content" rows="15"><?php echo $artikel['content']; ?></textarea>
            </div>
        </div>
